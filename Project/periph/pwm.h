...
namespace Project::Periph {
    ...
    struct PWM{
        ...
        void init(uint16_t prescaler, uint32_t period, uint32_t pulse,
                  Callback::Fn halfCBFn = nullptr, void *halfCBArg = nullptr,
                  Callback::Fn fullCBFn = nullptr, void *fullCBArg = nullptr)
        {
        ...
        /// @param fullCBFn complete callback function pointer
        /// @param fullCBArg complete callback function argument
        void setCallback(Callback::Fn halfCBFn = nullptr, void *halfCBArg = nullptr,
                         Callback::Fn fullCBFn = nullptr, void *fullCBArg = nullptr)
        {
            halfCB = { halfCBFn, halfCBArg };
            fullCB = { fullCBFn, fullCBArg };
        }
