...
namespace Project {
    ...
    uint32_t EEPROM::write(uint32_t StartPageAddress, uint32_t *Data, uint16_t numberofwords) {
    ...
    void EEPROM::read(uint32_t StartPageAddress, uint32_t *RxBuf, uint16_t numberofwords) {
        while (true) {
